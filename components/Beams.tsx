...
function extendMaterial(
  ...
  Object.entries(cfg.uniforms ?? {}).forEach(([key, u]) => {
    uniforms[key] =
      u !== null && typeof u === "object" && u !== null && "value" in (u as object)
        ? (u as { value: unknown })
        : { value: u };
  });
...
const Beams = ({
  ...
  return (
    <CanvasWrapper className="beams-container">
...
>(({ material, width, count, height }, ref) => {
  ...
  useFrame((_, delta) => {
    const mat = mesh.current?.material as THREE.ShaderMaterial & { uniforms: { time: { value: number } } };
