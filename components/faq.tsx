...
type FAQProps = {
  /** Light surfaces need visible beams; dark keeps white beams */
  chapterSurface?: "light" | "dark";
};

export function FAQ({ chapterSurface = "dark" }: FAQProps) {
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const beamColor = chapterSurface === "light" ? "#0099af" : "#ffffff";
